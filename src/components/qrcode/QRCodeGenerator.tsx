...
export function QRCodeGenerator() {
  ...
  return (
    <div className="card-elevated p-8 text-center max-w-md mx-auto animate-slide-up">
      ...
      {/* QR Code */}
      <div className="relative mx-auto w-64 h-64 bg-white rounded-2xl flex items-center justify-center mb-6 p-4 shadow-inner">
        {isLoading ? (
      ...
      <div className="mb-6">
        <div className="flex items-center justify-center gap-2 text-muted-foreground">
          ...
          <span className={`text-2xl font-bold font-display transition-colors ${getTimerColor()}`}>
            {expiresIn}s
          </span>
        </div>
      ...
      <Button onClick={generateQRCode} variant="outline" className="gap-2" disabled={isLoading}>
        {isLoading ? (
